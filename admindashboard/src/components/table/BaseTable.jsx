        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
          ...
          <div className="relative flex-1 sm:flex-initial group">
            ...
            <input
              ...
              className="w-full sm:w-72 pl-12 pr-4 py-3 bg-[#F8FAFC] hover:bg-[#F1F5F9] focus:bg-white border-2 border-transparent focus:border-[#0A4F48]/10 rounded-2xl text-sm font-semibold text-slate-700 transition-all outline-none placeholder:text-slate-400 placeholder:font-medium"
          ...
          <div className="flex items-center gap-3">
            {availableStatuses.length > 0 && (
              <div className="relative">
                <button
                  ...
                  className="h-[46px] px-4 bg-[#F8FAFC] hover:bg-[#F1F5F9] text-slate-600 rounded-2xl text-sm font-bold flex items-center gap-2 transition-all active:scale-95"
                >
                  <span className="truncate max-w-[100px]">{statusFilter}</span>
            ...
            {actionPath && (
              <button
                ...
                className="h-[46px] px-6 bg-[#0A4F48] hover:bg-[#084039] text-white rounded-2xl text-sm font-bold flex items-center gap-2 shadow-lg shadow-[#0A4F48]/25 hover:shadow-xl hover:shadow-[#0A4F48]/30 transition-all active:scale-95 hover:-translate-y-0.5"
              >
                ...
                {table.getRowModel().rows.map((row) => (
                  ...
                  >
                    {row.getVisibleCells().map((cell, index) => {
                      ...
                      >
                        {/* Mobile Label */}
                        <span className="md:hidden text-xs font-bold text-slate-400 min-w-[100px] uppercase tracking-wide">
                          {flexRender(
                            table.getHeaderGroups()[0]?.headers[index]?.column
                              ?.columnDef?.header,
                            table

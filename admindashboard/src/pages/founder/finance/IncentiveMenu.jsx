...
const IncentiveMenu = ({ setIncentiveOpen, incentiveOpen }) => {
  ...
  return (
    <div className="absolute z-20 w-full md:w-76 flex flex-col items-center gap-10 bg-white rounded-2xl p-4 shadow-[0_10px_30px_rgba(0,0,0,0.25)] md:right-1 top-1">
      ...
      <div className="flex justify-between items-center w-full">
        ...
        <button onClick={() => setIncentiveOpen(false)}>
          <IoMdClose />
        </button>
      </div>
      ...
      <div className="w-full flex flex-col gap-3">
        ...
        <button
          ...
          className={`w-full rounded-lg py-2.5 text-white font-semibold ${
            loading ? "bg-gray-100 cursor-not-allowed" : "bg-[#0A4F48]"
          }`}
        >
          {loading ? (

  ...
  return (
    <div className="bg-white rounded-2xl p-6 flex flex-col gap-6 shadow-sm border border-gray-50 flex-1 w-full ">
      ...
      <div className="flex items-center justify-end gap-3 mt-auto pt-4">
        <button className="px-5 py-2.5 bg-[#EBF3F2] text-[#0A4F48] rounded-lg text-xs font-bold hover:bg-[#dfecea] transition-colors">
          Edit
        </button>
        <button className="px-5 py-2.5 bg-[#0A4F48] text-white rounded-lg text-xs font-bold hover:bg-[#073a35] transition-colors">
          Send Test
        </button>
      </div>
    </div>

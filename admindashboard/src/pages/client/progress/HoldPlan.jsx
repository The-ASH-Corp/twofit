    ...
    <div className="space-y-6 flex flex-col h-full">
      <div className="space-y-2">
        ...
        <div className="relative">
          <button
            ...
            className="w-full border border-gray-200 rounded-xl p-3 flex items-center justify-between focus:outline-none focus:ring-2 focus:ring-[#0A4F48]/20 text-left"
          >
      ...
      <div className="space-y-2 flex-1">
        ...
        <textarea
          ...
          className="w-full h-48 border border-gray-200 rounded-xl p-3 focus:outline-none focus:ring-2 focus:ring-[#0A4F48]/20 resize-none"
        />
      </div>

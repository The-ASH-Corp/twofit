import { ArrowLeft, Bell, Menu, Mic, Paperclip, Square } from "lucide-react";
            ...
            <div className="flex items-center gap-2 lg:gap-3 bg-gray-50 rounded-xl lg:rounded-lg p-2">
              ...
              >
                {isRecording ? (
                  <Square
                    size={20}
                    className="lg:text-red-600 text-white bg-red-600 rounded-full p-1 w-7 h-7 lg:w-5 lg:h-5 lg:bg-transparent lg:p-0"
                  />
                ) : (
                  <Mic
                    size={20}
                    className="lg:text-gray-400 text-white bg-[#0A4F48] rounded-full p-1 w-7 h-7 lg:w-5 lg:h-5 lg:bg-transparent lg:p-0"
                  />
                )}
              </button>
              <button
